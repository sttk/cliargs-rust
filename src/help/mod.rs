...
struct Block {
    ...
    margin_left: usize,
    margin_right: usize,
    bodys: Vec<(usize, String)>, // The vector of tuples of (first indent, text body)

    _spaces: String,
}

impl Help {
    /// Creates an [Help] instance with 0 margins of a help text.
    pub fn new() -> Self {
        Self {
            margin_left: 0,
            margin_right: 0,
    ...
    /// Creates an [Help] instance with left and right margins of a help text.
    ...
    ///
    /// The indent width of a help text block is `0` (= auto indent).
    ...
    ///
    /// The margins of a help text generated by this instance equals the sum of them specified as
    /// parameters of this method and them which specified at the `new` function.
    /// The indent width of a help text block is `0` (= auto indent).
